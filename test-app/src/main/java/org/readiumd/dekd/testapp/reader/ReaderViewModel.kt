...
import org.readiumd.dekd.navigator.Decoration
...
import org.readiumd.dekd.shared.publication.services.search.SearchIterator
import org.readiumd.dekd.shared.publication.services.search.SearchTry
import org.readiumd.dekd.shared.publication.services.search.search
import org.readiumd.dekd.shared.util.Try
import org.readiumd.dekd.testapp.bookshelf.BookRepository
import org.readiumd.dekd.testapp.domain.model.Highlight
import org.readiumd.dekd.testapp.search.SearchPagingSource
...
class ReaderViewModel(
    ...
    class Factory(
        private val application: org.readiumd.dekd.testapp.Application,
