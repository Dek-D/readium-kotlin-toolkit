...
package org.readiumd.dekd.testapp.epub
...
import org.readiumd.dekd.navigator.R2BasicWebView
import org.readiumd.dekd.navigator.R2WebView
import org.readiumd.dekd.navigator.epub.fxl.R2FXLLayout
...
import org.readiumd.dekd.shared.*
import org.readiumd.dekd.testapp.R
import org.readiumd.dekd.testapp.databinding.PopupWindowUserSettingsBinding
import org.readiumd.dekd.testapp.reader.ReaderActivity
import org.readiumd.dekd.testapp.utils.extensions.color
import java.io.File
...
class UserSettings(var preferences: SharedPreferences, val context: Context, private val UIPreset: MutableMap<ReadiumCSSName, Boolean>) {
    ...
    private val fontFamilyValues = listOf(
        "Original",
        "PT Serif",
        "Roboto",
        "Source Sans Pro",
