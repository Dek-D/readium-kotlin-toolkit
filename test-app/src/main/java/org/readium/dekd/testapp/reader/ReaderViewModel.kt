...
import org.readium.dekd.navigator.Decoration
import org.readium.dekd.navigator.ExperimentalAudiobook
import org.readium.dekd.navigator.ExperimentalDecorator
...
import org.readium.dekd.shared.publication.services.search.SearchIterator
import org.readium.dekd.shared.publication.services.search.SearchTry
import org.readium.dekd.shared.publication.services.search.search
import org.readium.dekd.shared.util.Try
import org.readium.dekd.testapp.bookshelf.BookRepository
import org.readium.dekd.testapp.domain.model.Highlight
import org.readium.dekd.testapp.search.SearchPagingSource
...
class ReaderViewModel(
    ...
    class Factory(
        private val application: org.readium.dekd.testapp.Application,
