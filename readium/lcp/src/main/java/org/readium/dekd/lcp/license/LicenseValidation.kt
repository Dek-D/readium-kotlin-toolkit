...
import org.readium.dekd.lcp.LcpAuthenticating
...
import org.readium.dekd.lcp.service.*
            ...
            error = if (status != null) {
                ...
                when (status.status) {
                    ...
                    StatusDocument.Status.revoked -> {
                        val devicesCount = status.events(org.readium.dekd.lcp.license.model.components.lsd.Event.EventType.register).size
