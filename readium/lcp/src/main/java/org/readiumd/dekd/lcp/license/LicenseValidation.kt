...
import org.readiumd.dekd.lcp.LcpAuthenticating
...
import org.readiumd.dekd.lcp.service.*
            ...
            error = if (status != null) {
                ...
                when (status.status) {
                    ...
                    StatusDocument.Status.revoked -> {
                        val devicesCount = status.events(org.readiumd.dekd.lcp.license.model.components.lsd.Event.EventType.register).size
