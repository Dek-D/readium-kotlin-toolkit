...
import org.readium.dekd.navigator.*
import org.readium.dekd.navigator.databinding.ActivityR2ViewpagerBinding
import org.readium.dekd.navigator.epub.EpubNavigatorViewModel.RunScriptCommand
import org.readium.dekd.navigator.extensions.htmlId
import org.readium.dekd.navigator.extensions.optRectF
import org.readium.dekd.navigator.extensions.positionsByResource
import org.readium.dekd.navigator.extensions.withBaseUrl
import org.readium.dekd.navigator.html.HtmlDecorationTemplates
import org.readium.dekd.navigator.pager.R2EpubPageFragment
import org.readium.dekd.navigator.pager.R2PagerAdapter
import org.readium.dekd.navigator.pager.R2PagerAdapter.PageResource
import org.readium.dekd.navigator.pager.R2ViewPager
import org.readium.dekd.navigator.util.createFragmentFactory
import org.readium.dekd.shared.COLUMN_COUNT_REF
import org.readium.dekd.shared.InternalReadiumApi
import org.readium.dekd.shared.SCROLL_REF
import org.readium.dekd.shared.extensions.addPrefix
import org.readium.dekd.shared.extensions.tryOrLog
import org.readium.dekd.shared.publication.*
import org.readium.dekd.shared.publication.epub.EpubLayout
import org.readium.dekd.shared.publication.presentation.presentation
import org.readium.dekd.shared.publication.services.isRestricted
import org.readium.dekd.shared.publication.services.positionsByReadingOrder
import org.readium.dekd.shared.util.launchWebBrowser
