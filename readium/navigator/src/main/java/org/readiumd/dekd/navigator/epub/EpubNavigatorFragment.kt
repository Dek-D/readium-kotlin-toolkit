...
package org.readiumd.dekd.navigator.epub
...
import org.readiumd.dekd.navigator.*
import org.readiumd.dekd.navigator.databinding.ActivityR2ViewpagerBinding
import org.readiumd.dekd.navigator.epub.EpubNavigatorViewModel.RunScriptCommand
import org.readiumd.dekd.navigator.extensions.htmlId
import org.readiumd.dekd.navigator.extensions.optRectF
import org.readiumd.dekd.navigator.extensions.positionsByResource
import org.readiumd.dekd.navigator.extensions.withBaseUrl
import org.readiumd.dekd.navigator.html.HtmlDecorationTemplates
import org.readiumd.dekd.navigator.pager.R2EpubPageFragment
import org.readiumd.dekd.navigator.pager.R2PagerAdapter
import org.readiumd.dekd.navigator.pager.R2PagerAdapter.PageResource
import org.readiumd.dekd.navigator.pager.R2ViewPager
import org.readiumd.dekd.navigator.util.createFragmentFactory
import org.readiumd.dekd.shared.COLUMN_COUNT_REF
import org.readiumd.dekd.shared.InternalReadiumApi
import org.readiumd.dekd.shared.SCROLL_REF
import org.readiumd.dekd.shared.extensions.addPrefix
import org.readiumd.dekd.shared.extensions.tryOrLog
import org.readiumd.dekd.shared.publication.*
import org.readiumd.dekd.shared.publication.epub.EpubLayout
...
import org.readiumd.dekd.shared.publication.services.positionsByReadingOrder
import org.readiumd.dekd.shared.util.launchWebBrowser
