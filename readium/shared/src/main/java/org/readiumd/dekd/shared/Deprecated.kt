...
typealias RenditionLayout = org.readiumd.dekd.shared.publication.epub.EpubLayout
...
fun parsePublication(pubDict: JSONObject): org.readiumd.dekd.shared.publication.Publication {
    return org.readiumd.dekd.shared.publication.Manifest.fromJSON(pubDict)?.let { Publication(it) }
