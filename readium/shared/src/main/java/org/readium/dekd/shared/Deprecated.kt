...
typealias RenditionLayout = org.readium.dekd.shared.publication.epub.EpubLayout
...
fun parsePublication(pubDict: JSONObject): org.readium.dekd.shared.publication.Publication {
    return org.readium.dekd.shared.publication.Manifest.fromJSON(pubDict)?.let { Publication(it) }
